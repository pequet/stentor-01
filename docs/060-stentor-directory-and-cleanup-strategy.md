...
*   **`~/.stentor/`**
    ...
    *   **Contents:**
        ...
        *   `stentor.conf` (Optional): Client-specific environment variables (e.g., SSH details for mounting). Overridden by a project-local `stentor.conf`.
...
*   **`$PATH_TO_PROJECT_REPO/Stentor-01/`** (e.g., `/Users/Shared/Git/repositories/Stentor-01/`)
    ...
    *   `stentor.conf` (Optional): Project-specific environment variables, takes precedence over `~/.stentor/stentor.conf`.
